...
# clone my repo
git clone https://github.com/jingtai05/java-booking-system
```
**open your IDE and run !**

## Login Credentials
* **Predefined Users:** Can view in users.txt file
1. TC123456,lecturer1
2. TP123456,student1
* **Create an Account:** Via User Interface
1. Select your role 
